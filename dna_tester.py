...
def test3():
    ...
    print(dna.is_match(dna_seq1, dna_seq2) is True, end=" ")

    dna_seq2 = linked_code.insert_at(0, "A", dna_seq2)
    print(dna.is_match(dna_seq1, dna_seq2) is False, end=" ")
    print(dna.is_match(dna_seq2, dna_seq1) is False, end=" ")
    ...
    dna_seq2 = linked_code.insert_at(2, "G", dna_seq2)
    print(dna.is_match(dna_seq1, dna_seq2) is False)
